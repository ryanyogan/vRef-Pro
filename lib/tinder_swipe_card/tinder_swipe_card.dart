...
class CardController {
  ...
  void triggerLeft(int totalIndex, int lastIndex) {
    if (_listener != null) {
      if (totalIndex != lastIndex) {
        print("Total index $totalIndex  last index : $lastIndex");
        _listener(TriggerDirection.left);
      }
    }
  }

  void triggerRight(int totalIndex, int lastIndex) {
    if (_listener != null) {
      if (totalIndex == lastIndex) _listener(TriggerDirection.right);
    }
  }
